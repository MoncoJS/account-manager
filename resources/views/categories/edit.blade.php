...
<div class="card shadow-sm">
    <div class="card-header bg-white">
        <h4 class="mb-0">
            <i class="bi bi-pencil text-primary"></i> แก้ไขหมวดหมู่
        </h4>
    </div>
    <div class="card-body">
            ...
            <div class="row">
                ...
                <div class="col-md-6 mb-3">
                    ...
                    <select name="type" class="form-select @error('type') is-invalid @enderror" required>
                        <option value="income" {{ old('type', $category->type) == 'income' ? 'selected' : '' }}>รายรับ</option>
                        <option value="expense" {{ old('type', $category->type) == 'expense' ? 'selected' : '' }}>รายจ่าย</option>
                    </select>
                    @error('type')
                        <div class="invalid-feedback">{{ $message }}</div>
                    @enderror
                ...
                <div class="col-md-6 mb-3">
                    ...
                    <div class="input-group">
                        <span class="input-group-text">
                            <i class="bi {{ $category->icon ?? 'bi-emoji-smile' }}"></i>
                        </span>
